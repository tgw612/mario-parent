...
import com.mario.ali.mq.consumer.RocketMqBatchConsumerBean;
...
/**
 * 注意 （RocketMqBatchMessageListener） bean的名字 不能与 消费组(mq.consumers.fileExportConsumer)配置的名字一样
 */
@Slf4j
@Data
@EnableConfigurationProperties(MqEnvProperties.class)
public class RocketMqBatchConsumerPostBean extends RocketMqBatchConsumerBean implements
    InitializingBean {
  ...
  public RocketMqBatchConsumerPostBean(MqEnvProperties mqEnvProperties) {
