...
public final class CustomShardingProperties {
    ...
    private String getErrorMessage(CustomShardingPropertiesConstant shardingPropertiesConstant, String invalidValue) {
    ...
    public <T> T getValue(CustomShardingPropertiesConstant shardingPropertiesConstant) {
        ...
        if (Boolean.TYPE == shardingPropertiesConstant.getType()) {
            ...
            return Long.TYPE == shardingPropertiesConstant.getType() ? (T) Long.valueOf(result) : (T) result;
        }
    }
